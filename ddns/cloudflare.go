...
// 	// req.DeldomainName("lllllll.test.top.lbtest.top")

// 	req.modifyDNSRecord(DNSRecord{
// 		Name:    "lllllll.lbtest.top",
// 		Type:    TypeA,
// 		Content: "11.11.11.11",
// 		Ttl:     111,
// 	}, "710ab9bd02973613d63352c25c2f4daf")
// 	// req.DeldomainName("lllllll.lbtest.top")
// 	str := req.GetAll()
// 	for k, _ := range str {
// 		d := str[k]
// 		for _, v := range d {
...
// 	// telegram.Send(str)
// 	// fmt.Println(req.Zonelist[0].ZDomain)
